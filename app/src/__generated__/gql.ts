 ...
 */
type Documents = {
    "\n  fragment Person_ActivityList on Person {\n    id\n    activities {\n      id\n      title\n      description\n      location\n      occurredAt\n    }\n  }\n": typeof types.Person_ActivityListFragmentDoc,
    ...
    "\n  fragment Person_Tasks on Person {\n    id\n    tasks {\n      id\n      title\n      notes\n      dueAt\n      completedAt\n      createdAt\n    }\n  }\n": typeof types.Person_TasksFragmentDoc,
...
const documents: Documents = {
    "\n  fragment Person_ActivityList on Person {\n    id\n    activities {\n      id\n      title\n      description\n      location\n      occurredAt\n    }\n  }\n": types.Person_ActivityListFragmentDoc,
    ...
    "\n  fragment ContactInfo_List on Person {\n    id\n    contactInfos {\n      id\n      type\n      value\n      label\n      isPrimary\n    }\n  }\n": types.ContactInfo_ListFragmentDoc,
    "\n  mutation CreateContactInfo(\n    $personId: String!\n    $type: ContactInfosTypeEnum!\n    $value: String!\n    $label: String\n    $isPrimary: Boolean\n  ) {\n    createContactInfo(\n      values: {\n        personId: $personId\n        type: $type\n        value: $value\n        label: $label\n        isPrimary: $isPrimary\n      }\n    ) {\n      id\n      personId\n      type\n      value\n      label\n      isPrimary\n    }\n  }\n": types.CreateContactInfoDocument,
    "\n  mutation DeleteContactInfo($id: String!) {\n    deleteContactInfos(where: { id: { eq: $id } }) {\n      id\n    }\n  }\n": types.DeleteContactInfoDocument,
