...
export type WeeklyReviewQuery = { persons: Array<{ __typename: 'Person', id: string, firstName: string, lastName: string, avatarPath: string | null, contactFrequency: string | null, createdAt: string, importantDates: Array<{ __typename: 'PersonImportantDatesRelation', id: string, name: string, date: string, recurrence: string | null }>, tasks: Array<{ __typename: 'PersonTasksRelation', id: string, title: string, dueAt: string | null, completedAt: string | null, personId: string }>, interactions: Array<{ __typename: 'PersonInteractionsRelation', occurredAt: string }> }> };
